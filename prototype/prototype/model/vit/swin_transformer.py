...
from .layers import DropPath, to_2tuple, WindowAttention, window_partition, window_reverse, VanillaMlp
...
class SwinTransformer(VisionTransformer):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        super().__init__(img_size, patch_size, in_chans, num_classes, embed_dim, depth,
                         ...
                         drop_rate, attn_drop_rate, drop_path_rate, apply_layer_norm)
    ...
    def init_norm_layer(self):
        self.norm_layer = partial(self.norm_layer, eps=1e-6) if self.patch_norm else None

...
SKIP_DIST=1 PYTHONPATH=$PYTHONPATH:../../../ GLOG_vmodule=MemcachedClient=-1 python -u -m prototype.prototype.solver.imgnet_p_eval_solver --config config.yaml --evaluate

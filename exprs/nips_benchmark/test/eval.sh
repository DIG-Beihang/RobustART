...
python -u -m  prototype.prototype.solver.module_benchmark_eval_adv --config config.yaml --src_name ${model_names[${i}]} --src_path ${model_paths[${i}]} --tgt_name ${model_names[${i}]} --tgt_path ${model_paths[${i}]} --attack autoattack_linf --eps 0.5/255
